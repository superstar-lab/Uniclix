    ...
    public function scopeFormattedForDisplay($query)
    {
        ...
        foreach($plans as $plan){
            ...
            $planData[] = [
                 ...
                 "Schedule and Publish" => $plan->permissions->contains("name", "scheduling") && $plan->permissions->contains("name", "schedule-best-time") ? true : 'Limited',
                 "Content Curation" => $plan->name == 'free' ? 'Limited' : $plan->permissions->contains("name", "articles"),

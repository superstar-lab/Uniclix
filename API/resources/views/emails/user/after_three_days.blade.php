                                                                            ...
                                                                            <tr>
                                                                                <td align="center" style="padding: 0px 40px;" class="mlContentOuter">
                                                                                    <table cellpadding="0" cellspacing="0" border="0" align="center" width="100%">
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td align="center" class="bodyTitle" style="font-family: 'Poppins', sans-serif; font-size: 28px; font-weight: 700; line-height: 34px; color: #111111; text-transform: none; font-style: normal; text-decoration: none; text-align: center;">Scheduling an appointment</td>
                                                                                            </tr>
                                                                                        </tbody>
                                                                                    </table>
                                                                                </td>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="center" style="padding: 0px 40px;" class="mlContentOuter">
                                                                                        <table cellpadding="0" cellspacing="0" border="0" align="center" width="100%">
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td class="bodyTitle" id="bodyText-6" style="font-family: 'Poppins', sans-serif; font-size: 14px; line-height: 24px; color: #6f6f6f;">
                                                                                                        ...
                                                                                                        <tbody>
                                                                                                            <tr>
                                                                                                                <td align="center" class="mlContentButton" style="font-family: 'Poppins', sans-serif;">
                                                                                                                    <!--[if mso]>
                                                      <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://calendly.com/uniclix/30min?&utm_source=newsletter&utm_medium=email&utm_campaign=scheduling_an_appointment_with_you_for_uniclix&" data-link-id="334210540" style="height:50px;v-text-anchor:middle;width:319px;" arcsize="6%" stroke="f" fillcolor="#2d8cff">
                                                        <w:anchorlock/>
                                                        <center>
                                                        <![endif]-->
                                                                                ...
                                                                                <tr>
                                                                                    <td align="center" style="padding: 0px 40px;" class="mlContentOuter">
                                                                                        <table cellpadding="0" cellspacing="0" border="0" align="center" width="100%">
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td class="bodyTitle" id="bodyText-10" style="font-family: 'Poppins', sans-serif; font-size: 14px; line-height: 24px; color: #6f6f6f;">
                                                                                                        <p style="margin-top: 0px; margin-bottom: 10px; line-height: 24px; text-align: center;"></p>
                                                                                                        <p style="margin-top: 0px; margin-bottom: 10px; line-height: 24px;">Looking forward to hearing from you! </p>
                                                                                                        <p style="margin-top: 0px; margin-bottom: 10px; line-height: 24px;">Best wishes!</p>
                                                                                                        <p style="margin-top: 0px; margin-bottom: 10px; line-height: 24px;">Lumi </p>
                                                                                                        <p style="margin-top: 0px; margin-bottom: 10px; line-height: 24px;"><a href="{{config('app.url')}}" data-link-id="334215222" target="_blank" style="word-break: break-word; font-family: 'Poppins', sans-serif; color: #09c269; text-decoration: underline;">Uniclixapp.com</a></p>
                                                                                        ...
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td align="center" id="imageBlock-12">
                                                                                                    <img src="https://bucket.mlcdn.com/a/1332/1332954/images/188df74ca184524a8521b8ee33c3d49dfff8ba6a.jpeg" border="0" alt="" width="560" style="display: block;">
                                                                                                </td>
                                                                                            </tr>
                                                                                        </tbody>
                                                                                    </table>

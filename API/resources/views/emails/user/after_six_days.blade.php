<html><head>
    ...
    <![endif]-->
    <style type="text/css">
      @media only screen and (max-width: 640px){ 		#imageBlock-6 img { 			max-width: 713px!important; 			width: 100%!important; 		} 	}
    </style>
    <title>Have you tried the content finder tool by UniClix?</title>
                                              ...
                                              <table border="0" cellpadding="0" cellspacing="0" width="100%" style="width: 100%; min-width: 100%;">
                                                <tbody><tr>
                                                  <td align="center" class="mlContentButton" style="font-family: 'Poppins', sans-serif;">
                                                    <!--[if mso]>
                                                      <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://uniclixapp.com?&utm_source=newsletter&utm_medium=email&utm_campaign=have_you_tried_the_content_finder_tool_by_uniclix&utm_term=2020-04-02" data-link-id="334224130" style="height:50px;v-text-anchor:middle;width:229px;" arcsize="6%" stroke="f" fillcolor="#2d8cff">
                                                        <w:anchorlock/>
                                                        <center>
                                                        <![endif]-->
                                                        <a class="mlContentButton" href="{{config('app.url')}}?&amp;utm_source=newsletter&amp;utm_medium=email&amp;utm_campaign=have_you_tried_the_content_finder_tool_by_uniclix" data-link-id="334224130" target="_blank" style="font-weight: 400; font-family: 'Poppins', sans-serif; border-radius: 3px; color: #ffffff; display: inline-block; font-size: 14px; background-color: #2d8cff; line-height: 20px; padding: 15px 0 15px 0; text-align: center; text-decoration: none; width: 200px;">Sign up now</a>
                                                        <!--[if mso]>
                                                        </center>
                                                      </v:roundrect>
                                                    <![endif]-->

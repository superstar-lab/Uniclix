  ...
  <div>
    <Switch>
      ...
      <Route
        exact
        path={`/accounts`}
        render={() => <Redirect to="/scheduled/posts" />}
      />
      ...
      />
      <Route
        path={`/settings/billing/thank-you-basic`}
        exact={true}
        component={CongratsPayment}
      />
      <Route
        path={`/settings/billing/thank-you-premium`}
        exact={true}
        component={CongratsPayment}
      />
      <Route
        path={`/settings/billing/thank-you-pro`}
        exact={true}
        component={CongratsPayment}
      />
      <Route

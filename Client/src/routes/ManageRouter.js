...
const ManageRouter = () => (
  <div>
    <Switch>
      ...
      <Route
        path={`/twitter-booster/account-targets`}
      ...
      <Route
        path={`/twitter-booster/recent-followers`}
        component={RecentFollowers}
      />
      <Route
        path={`/twitter-booster/inactive-following`}
        component={InactiveFollowing}
      />

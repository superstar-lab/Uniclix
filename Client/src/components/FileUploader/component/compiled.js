...
var ReactImageUploadComponent = (function (_React$Component) {
  ...
  function ReactImageUploadComponent(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (
        ReactImageUploadComponent.__proto__ ||
        Object.getPrototypeOf(ReactImageUploadComponent)
      ).call(this, props)
    );
    ...
    */
    ...
    },
    {
      ...
      value: function removeImage(picture) {
        ...
        this.setState(
          { pictures: filteredPictures, files: filteredFiles },
          function () {
    ...
    },
    {
      ...
      value: function renderErrors() {
        ...
        if (this.state.notAcceptedFileType.length > 0) {
          notAccepted = this.state.notAcceptedFileType.map(function (
            error,
            index
          ) {
        ...
        if (this.state.notAcceptedFileSize.length > 0) {
          notAccepted = this.state.notAcceptedFileSize.map(function (
            error,
            index
          ) {
            return _react2.default.createElement(
      ...
      value: function renderPreviewPictures() {
        ...
        return this.state.pictures.map(function (picture, index) {
          return _react2.default.createElement(
            ...
            _react2.default.createElement(
              _this5.props.fileType == "image" ? "img" : "video",
              { src: picture, className: "uploadPicture", alt: "preview" }
            )
          );
        });
      },

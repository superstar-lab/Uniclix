          ...
          <div className="item-list shadow-box">
            <div className="item-header">
              <button
                ...
                className="gradient-background-teal-blue default-button"
              >
                Done
              </button>
            </div>
  ...
  <div className="item-row">
    <div className="profile-info pull-left">
      ...
      <div className="pull-left">
        ...
        <p className="profile-name mt15">
          {target.name}{" "}
          <span className="profile-username">@{target.screen_name}</span>
        </p>
      </div>
    </div>
    <div className="item-actions pull-right">
      <ul>
        <li
          onClick={() => removeTarget(target.screen_name)}
          className="btn-links"
        >

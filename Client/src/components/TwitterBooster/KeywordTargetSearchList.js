              ...
              <form onSubmit={this.onSubmit}>
                <div className="form-row">
                  <div className="relative-pos">
                    <input
                      type="text"
                      className="form-control p20 search-input"
                    ...
                    <div className="btn-container">
                      {this.state.target ? (
                        <button className="gradient-background-teal-blue white-button add-target">
                          +
                        </button>
                      ) : (
                        <button
                          className="gradient-background-teal-blue white-button add-target disabled"
                          disabled
                        >
                          +
                        </button>
            ...
            <div className="added">
              ...
              <div>
                <div className={`section-header no-border mt20 mb20`}>
                  <div className="section-header__first-row"></div>
                ...
                <div className="added-items">
                  {this.state.suggestedTargets.map((target, index) =>
                    this.props.targets
                      ...
                      <div
                        key={index}
                        onClick={(e) => this.onSubmit(false, target.keyword)}
                      ...
                      this.props.targets.map((actualKey, e) => {
                        if (actualKey.keyword == target.keyword) {
                          return (
                            <div
                              key={e}
                              onClick={(e) => this.removeTarget(actualKey.id)}
              ...
              {this.props.targets.length >= 3 && (
                <button
                  onClick={() => this.props.showSearchView(false)}
                  className="btn-blue"
                >
...
const KeywordItem = ({ target, removeTarget }) => (
  <div className="keyword-item added-keyword">
    #{target.keyword}{" "}
    <i onClick={() => removeTarget(target.id)} className="fa fa-close"></i>
  </div>
);

...
class MonitorRightbar extends React.Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    if (
      prevProps.creators != this.props.creators &&
      this.props.creators != null
    ) {
      this.setState({ creators: this.props.creators });
    }
  }
  ...
  render() {
    ...
    return (
      <div className="monitor-right-bar" id="monitor-right-bar">
        <Button variant="contained" size="small" style={rightMenuStyle} />
        {isSelected && (
        ...
        <div>
          ...
          <Popup
            ...
            trigger={
              <div>
                <StylesButton
                  className="cardlist-secondbtn"
                  data-for="account"
                  data-tip
                  data-event-off="scroll mousewheel blur"
                  data-iscapture="true"
            ...
            {(close) => (
              <div className="account-modal">
                ...
                <div className="account-modal button">
                  <Button
                    className="account-modal button title"
                    onClick={close}
                  >
                    OK
                  </Button>
          ...
          <ReactTooltip
            ...
            delayShow={400}
          >
            <Typography className="cardlist-tooltiplabel">
              Select Account
            </Typography>
          </ReactTooltip>
        </div>

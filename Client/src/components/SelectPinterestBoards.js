      ...
      <div className="modal-content">
          ...
          {!!boards.length ? (
            boards.map((board) => (
              ...
              >
                <input
                  type="checkbox"
                  onChange={() => this.onChange(board)}
                  defaultChecked={board.selected ? "checked" : ""}
            ...
            <div>
              Please make sure you have created at least one board on your
              pinterest account.
            </div>
          )}
        </div>
        ...
        <div className="modal-footer">
          {!this.state.loading && (
            <div
              onClick={toggle}
              className="publish-btn-group gradient-background-teal-blue link-cursor pull-right"
            >

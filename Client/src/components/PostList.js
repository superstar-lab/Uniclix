    ...
    <div>
      ...
      {posts.length < 1 && !loading && (
        <SocialAccountsPrompt
          ...
          title={
            type !== "past-scheduled"
              ? "Save time with scheduled post"
              : "You have no old posts"
          }
          description={
            type == "unapproved-posts"
              ? "You have no post in approval queue"
              : "Use Compose box to schedule posts and publish automatically throughout the day or week"
          }
              ...
              <div key={index} className="item-list shadow-box">
                {postGroup.map((post) => (
                  <div
                    ...
                    style={{
                      borderColor: post.category ? post.category.color : "",
                    }}
                  >
                    <div className="row">
                      <div
                        ...
                        onClick={() => {
                          ...
                          setPost({
                            ...
                            images:
                              typeof post.payload.images !== "undefined"
                                ? post.payload.images.map(
                      ...
                      <div className="col-xs-12 col-md-2">
                        <ul className="compose-header">
                          {!!publishChannels.length &&
                            channelSelector(publishChannels, {
                              selected: true,
                              provider: undefined,
                            }).map((channel) => (
                              <li key={channel.id} className="channel-item">
                                ...
                                />
                                <i
                                  className={`fa fa-${channel.type} ${channel.type}_bg smallIcon`}
                                ></i>
                              </li>
                            ))}
                        </ul>
                        ...
                        <div className="pull-right">
                          ...
                          <ul>
                            <li className="text-links link-inactive">
                              <a
                                className="link-cursor danger-btn"
                                onClick={() =>
                                  setAction({ type: "delete", id: post.id })
                                }
                              >
                                Delete
                              </a>
                            ...
                            {type !== "unapproved-posts" ? (
                              <li className="text-links">
                                <a
                                  ...
                                  onClick={() =>
                                    setAction({ type: "post", id: post.id })
                                  }
                                >
                                  Post Now
                                </a>

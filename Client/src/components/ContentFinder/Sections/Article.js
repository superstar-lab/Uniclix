...
const Article = ({ article, postedArticle, toggleComposer }) => {
  if (article.posted == null) {
    if (
      typeof postedArticle !== "undefined" &&
      typeof postedArticle.articleId !== "undefined"
    ) {
      if (
        typeof postedArticle.posted !== "undefined" &&
        postedArticle.articleId == article.id
      ) {
      ...
      <div className="card-content">
        ...
        <div className="card-body">
          ...
          <p className="card-text">
            <small className="text-muted page">{article.source_url}</small>
          </p>
        </div>
      </div>
    </div>

...
class TwitterActions extends React.Component {
  ...
  likePost = () => {
    ...
    like(feedCurrentItem.id_str, channel.id)
      .then((response) => {
  ...
  unlikePost = () => {
    ...
    unlike(feedCurrentItem.id_str, channel.id)
      .then((response) => {
        this.setState(() => ({ loading: false }));
        if (typeof response !== "undefined") {
  ...
  retweetPost = () => {
    ...
    retweet(feedCurrentItem.id_str, channel.id)
      .then((response) => {
        this.setState(() => ({ loading: false }));
        if (typeof response !== "undefined") {
  ...
  render() {
    ...
    const likesCount =
      feedCurrentItem.favorite_count > 0
        ? abbrNum(feedCurrentItem.favorite_count)
        : "";
    const retweetCount =
      feedCurrentItem.retweet_count > 0
        ? abbrNum(feedCurrentItem.retweet_count)
        : "";
    return (
      <div>
        <ToastContainer
        ...
        <div className="stream-action-icons">
          ...
          <span>
            <img
              className="action-twitter-icon-button"
              onClick={() => this.retweetPost()}
              src="images/monitor-icons/retweets-contact.svg"
            />

...
class FacebookConversation extends React.Component {
  ...
  send = () => {
    ...
    sendMessage(content, conversationId, channelId)
      .then((response) => {
      ...
      <div className="t-reply-container scrollbar">
        ...
        <div className="t-reply-body fb-conversation-body scrollbar">
          {typeof messages !== "undefined" &&
            typeof messages.data !== "undefined" &&
            messages.data
              .map((message, index) => {
                return (
                  <div key={index} className={`stream-feed-container`}>
                    <div className="post-info">
                      <img
                        src={
                          channel.name === message.from.name
                            ? channel.avatar
                      ...
                      <div className="post-info-item">
                        ...
                        <div className="post-date">
                          {toHumanTime(message.created_time)}
                        </div>
                      </div>
                    </div>
          ...
          <div className="t-reply-actions">
            ...
            {this.state.letterCount < 1 ? (
              ...
              <button className="doneBtn">
                <i className="fa fa-circle-o-notch fa-spin"></i> Send
              </button>
            )}
          </div>
        </div>

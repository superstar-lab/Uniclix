                ...
                <div className="facebook-info-card-info">
                  {typeof user.fan_count !== "undefined" && user.fan_count && (
                    <div className="facebook-info-card-info-item">
                      <strong>Likes: </strong>
                      {abbrNum(user.fan_count)}
                    </div>
                  )}
                  {typeof user.about !== "undefined" && user.about && (
                    <div className="facebook-info-card-info-item">
                      <strong>About: </strong>
                      <ReadMore>{user.about}</ReadMore>
                    </div>
                  )}
                  {typeof user.company_overview !== "undefined" &&
                    user.company_overview && (
                      <div className="facebook-info-card-info-item">
                        <strong>Company Overview: </strong>
                        <ReadMore>{user.company_overview}</ReadMore>
                      </div>
                    )}
                  {typeof user.general_info !== "undefined" &&
                    user.general_info && (
                      <div className="facebook-info-card-info-item">
                        <strong>General Info: </strong>
                        <ReadMore>{user.general_info}</ReadMore>
                      </div>
                    )}

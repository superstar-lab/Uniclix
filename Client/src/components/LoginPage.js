...
export class LoginPage extends React.Component {
  state = {
    loading: false,
    register:
      this.props.location.search.indexOf("register") != -1 ? true : false,
    name: "",
    email: "",
    password: "",
    confirmPassword: "",
    error: "",
    isInvited:
      this.props.location.search.indexOf("fp_ref") != -1 ? true : false,
  };
              ...
              {!this.state.register ? (
                <div className="login-form">
                  ...
                  <p className="inline-txt">
                    ...
                    <a
                      href={`${backendUrl}/password/reset`}
                      className="btn btn-text-blue"
                    >
                      {" "}
                      Recover
                    </a>
          ...
          <div className="col-md-5 register-side">
            <div className="auth-switch-container">
              ...
              <button
                type="submit"
                onClick={this.toggleRegister}
                className="btn btn-text-pink auth-switch-btn"
              >
                Log in
              </button>
            </div>

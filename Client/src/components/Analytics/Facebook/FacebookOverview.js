...
class FacebookOverview extends React.Component {
  ...
  render() {
    const propData = {
      ...
      selectedChannel: channelById(this.props.channels, {
        id: this.state.selectedAccount.value,
      }),
    };
    return (
      <div>
        {!this.state.forbidden && !isEmptyObject(this.state.selectedAccount) ? (
          <div>
            <div className="row">
              <div className="col-xs-12">
                <div className="analytics-head">
                  <div className="analytics-head-left">Facebook Overview</div>
                ...
                infoData={[
                  {
                    ...
                    description:
                      "Get a meaningful and concise snapshot of your key Twitter, Facebook, and LinkedIn activities.",
                  },
                  {
                    title: "Engagement Metrics",
                    description:
                      "Get a clear view of engagement for each of your social media accounts.",
                  },
                  {
                    title: "Post Performance Metrics",
                    description:
                      "Track engagement for all of your individual post in one platform.",
                  },
                ]}
...
const mapStateToProps = (state) => {
  const facebookChannelsFilter = {
    selected: undefined,
    provider: "facebook",
    publishable: true,
  };
  const channels = channelSelector(state.channels.list, facebookChannelsFilter);
  const selectedChannel = channelSelector(state.channels.list, {
    selected: 1,
    provider: "facebook",
    publishable: true,
  });

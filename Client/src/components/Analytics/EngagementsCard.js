...
class EngagementsCard extends React.Component {
  ...
  render() {
    const { engagementType, data, period, isLoading } = this.props;
          ...
          <React.Fragment>
            <div className="graphics">
              ...
              <div className="right-side">
                <img
                  src={`/images/icons/analytics-line-${COLOR_LINE[engagementType]}.svg`}
                />
            ...
            <div className="total-period">
              <span className="amount">{`${
                data.totalEngagementInPeriod
              } ${engagementType.toLowerCase()}`}</span>
              {` this ${period}`}
            </div>
          </React.Fragment>
        )}

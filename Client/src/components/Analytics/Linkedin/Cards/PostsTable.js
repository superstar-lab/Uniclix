    ...
    return (
      <div className="overview-card">
        <div className="card-header">
          <img className="card-img" src="/images/linkedin-logo.png"></img>{" "}
          {name}
          ...
          {this.state.posts != null && !this.state.loading ? (
            <div className="table-wrapper-scroll-y table-scrollbar">
              <table className="table table-striped mb-0">
                <thead>
                  <tr>
                    <th scope="col" className="anl-posts-table-th-first">
                      Date
                    </th>
                    <th scope="col" className="anl-posts-table-th-second">
                      Message
                    </th>
                    ...
                    <tr key={index} scope="row">
                      <td className="anl-posts-table-th-first" scope="row">
                        <div className="post-table-images">
                          <img
                            className="pt-page-img"
                            src={this.props.selectedChannel.avatar}
                          />
                          <img
            ...
            <div className="table-loader-style">
              {this.state.loading && (
                <Loader type="Bars" color="#46a5d1" height={70} width={70} />
              )}
            </div>
          )}
        </div>

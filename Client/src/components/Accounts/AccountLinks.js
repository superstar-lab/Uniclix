        ...
        <div className="">
            ...
            <div className="account_box twitter_bg col-xs-12">
              <div>
                <div className="center-inline">
                  <i className="fa fa-twitter xl_font"></i>
                </div>
                <h4>Add Twitter Accounts</h4>
                <p className="center-inline">
                  Connected: {this.props.twitterChannels.length}
                </p>
              </div>
            </div>
          </NavLink>
          <NavLink to="/accounts/facebook">
            <div className="account_box facebook_bg col-xs-12">
              <div>
                <div className="center-inline">
                  <i className="fa fa-facebook xl_font"></i>
                </div>
                <h4>Add Facebook Accounts</h4>
                <p className="center-inline">
                  Connected: {this.props.facebookChannels.length}
                </p>
              </div>
            </div>
          </NavLink>
          ...
          <NavLink to="/accounts/linkedin">
            <div className="account_box linkedin_bg whiteTxt col-xs-12">
              <div>
                <div className="center-inline">
                  <i className="fa fa-linkedin xl_font"></i>
                </div>
                <h4>Add Linkedin Accounts</h4>
                <p className="center-inline">
                  Connected: {this.props.linkedinChannels.length}
                </p>
              </div>
            </div>
          </NavLink>
...
const mapStateToProps = (state) => {
  ...
  const pinterestChannelsFilter = {
    selected: undefined,
    provider: "pinterest",
  };
  const facebookChannels = channelSelector(
    state.channels.list,
    facebookChannelsFilter
  );
  const twitterChannels = channelSelector(
    state.channels.list,
    twitterChannelsFilter
  );
  const linkedinChannels = channelSelector(
    state.channels.list,
    linkedinChannelsFilter
  );
  const pinterestChannels = channelSelector(
    state.channels.list,
    pinterestChannelsFilter
  );
  return {
    facebookChannels,
    twitterChannels,

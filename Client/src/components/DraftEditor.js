...
class DraftEditor extends React.Component {
  ...
  state = {
    ...
    showEmojiIcon:
      typeof this.props.showEmojiIcon !== "undefined"
        ? this.props.showEmojiIcon
        : true,
    showImagesIcon:
      typeof this.props.showImagesIcon !== "undefined"
        ? this.props.showImagesIcon
        : true,
    showVideosIcon:
      typeof this.props.showVideosIcon !== "undefined"
        ? this.props.showVideosIcon
        : true,
    showHashtagsIcon:
      typeof this.props.showHashtagsIcon !== "undefined"
        ? this.props.showHashtagsIcon
        : true,
    placeholderText:
      typeof this.props.placeholderText !== "undefined"
        ...
        : "What's on your mind?",
    singleImage:
      typeof this.props.singleImage !== "undefined"
  ...
  onImageIconClick = () => {
    this.imageIcon.current.inputElement.previousSibling.click();
  };
  ...
  onVideoIconClick = () => {
    ...
    if (selectedLinkedIn == true) {
      FunctionModal({
        ...
        title: "Warning",
        content:
          "Video scheduling is not supported with LinkedIn due to LinkedIn API.",
  ...
  onOpenFileBrowser = () => {
    this.videoRef.current.inputElement.previousSibling.click();
  };
  ...
  onHashtagSearchChange = ({ value }) => {
    this.setState(() => ({
      hashtagSuggestions: defaultSuggestionsFilter(
        value,
  ...
  render() {
    ...
    const { scheduledLabel, inclusive, toggle, network, imageLimit } =
      this.props;
                ...
                <div className="editor" onClick={this.focus}>
                  ...
                  <HashtagSuggestions
                    ...
                    onClose={() =>
                      this.setState({
                        ...this,
                        suggestions: hashtagSuggestionList,
                      })
                    }
                  />
                </div>

...
class TodaysAgenda extends React.Component {
  ...
  filterTodaysByTimezone = (post) => {
    ...
    return (
      postDateTime.date() === currentDate.date() &&
    ...
    return (
      <div className="agenda-container">
          ...
          <div className="todays-agenda">
                    ...
                    <React.Fragment>
                      {showTime && (
                        <div className="time-title">
                          <div className="time">
                            {moment(post.payload.scheduled.publishUTCDateTime)
                              .tz(timezone)
                              .format("h.mm A")}
                          </div>
            ...
            {!agendaPosts.length && (
              <div className="no-agenda">
                ...
                <div className="no-agenda-msg">
                  Once you schedule posts they will show up here.
                </div>
              </div>
            )}
          </div>
        ...
        <div className={`post-queue-bar ${showAgenda ? "open" : ""}`}>
          ...
          <div className={`calendar-opt option`} onClick={startTour}>

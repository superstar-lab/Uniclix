...
class DateRangeSelector extends React.Component {
    ...
    switch (selectedPeriod) {
      ...
      case "Week":
        newStartDate = newStartDate
          .clone()
          .startOf(selectedPeriod.toLowerCase());
    ...
    switch (selectedPeriod) {
      ...
      case "Week":
        referenceDate = newStartDate
          .clone()
          .add(toAdd, selectedPeriod.toLowerCase());
        newStartDate = referenceDate
          .clone()
          .startOf(selectedPeriod.toLowerCase());
  ...
  renderDateRangePicker = () => {
    ...
    switch (selectedPeriod) {
      case "Day":
        dateStructure = (
          <span>{`${startDate.date()} ${UTC_MONTHS[startDate.month()]}`}</span>
        );
        break;
      case "Week":
        dateStructure = (
          <span>
            ...
            } - ${endDate.date()} ${UTC_MONTHS[endDate.month()]}`}
          </span>
        );
        break;
      case "Month":

...
class ScheduleWizard extends React.Component {
  ...
  closeComposer = (nextStep, toggleCard) => {
    ...
    const intervalId = setInterval(() => {
      ...
      const dayViewOption = document.querySelectorAll(
...
const tourWizardConfig = [
  {
    ...
    message:
      "Create a post by clicking into the text box. You can add an emoji or an image and chose to post it now or schedule it for later.",
  ...
  },
  {
    ...
    message:
      "Start creating your content by adding text, links, emojis, photos or videos to your post.",
  ...
  },
  {
    ...
    message:
      "You can configure multiple accounts to publish your content at the same time. Just click on the + button and add as many as you want.",
  ...
  },
  {
    ...
    message:
      "You have the option to categorize your content by selecting one of our pre-defined categories.",
  ...
  },
  {
    ...
    message:
      "Visualize a preview of your content on the social networks you have selected.",
  ...
  },
  {
    ...
    message: (
      <div className="schedule-wizard-types">
        <div>
          By clicking on the button dropdown, you can display other scheduling
          options.
        </div>
        <ul>
          <li>
            <span className="bold-text">Post now</span> - <i>instant share</i>
          </li>
          <li>
            <span className="bold-text">Schedule post</span> -{" "}
            <i>select a date and time</i>
          </li>
          <li>
            <span className="bold-text">Add to queue</span> -{" "}
            <i>add to next available spot</i>
          </li>
        </ul>
      </div>
    ),
  ...
  },
  {
    ...
    message:
      "Schedule a post for a specific day and time by selecting a desired slot.",
  ...
  },
  {
    ...
    message:
      "Choose frequency and timings of your posts by adjusting your settings.",
  ...
  },
  {
    ...
    message:
      "Select time slots you want add to your Post Schedule - these are your recommended best times to post.",
...
const tutorialFinalMsg = {
  ...
  title: "Thats all!",
  message:
    "Now you know how to manage your posts easily. What will you share next?",
  buttonLabel: "Got it!",
};

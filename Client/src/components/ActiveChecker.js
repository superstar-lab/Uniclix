...
class ActiveChecker extends React.Component {
  ...
  componentDidMount() {
    this.setState(() => ({
      active: this.props.selectedChannel
  ...
  onPinterestSuccess = (response) => {
    try {
      this.setState(() => ({ loading: true }));
      this.props
        .startAddPinterestChannel(response.accessToken)
        .then(() => {
          this.setState(() => ({ loading: false }));
        })
        .catch((error) => {
            ...
            <div className="form-group flex_container-center center-inline">
              ...
              {this.props.channels.length ? (
                <div>
                  ...
                  <p>
                    {" "}
                    Social networks need to be reconnected in UniClix for a
                    variety of reasons, such as software updates or password
                    changes. Reconnect your {selectedChannel.type} Account
                  </p>
                </div>
              ) : (
                <div>
                  ...
                  <p>
                    {" "}
                    In order to use Uniclix features, you need to connect at
                    least one social account.
                  </p>
                </div>
              )}
            </div>

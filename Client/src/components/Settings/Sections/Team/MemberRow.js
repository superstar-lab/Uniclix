    ...
    removeMember({
      ...
      .catch((error) => {
        ...
        FunctionModal({
          ...
          title: "Error",
          content:
            "Something went wrong when trying to delete the member, please try again later.",
        });
      });
  };
    ...
    return (
      <div className="team-member-row">
        <div className="left-section">
          ...
          <div className="email">{member.details.email}</div>
        </div>
        ...
        <div className="right-section">
          ...
          <div className="role">{member.is_admin ? "Admin" : "Member"}</div>

...
class Profile extends React.Component {
  ...
  filterCountry = (e) => {
    ...
    let countries = Countries.filter((item) =>
  ...
  initializeProfileData = () => {
    if (this.props.profile) {
      ...
      stateCopy["organizationName"] = user.organization_name
      ...
      stateCopy["timezone"] = user.timezone
        ? user.timezone
        : momentTz.tz.guess();
      ...
      <div>
        ...
        <div className="tab-cnt">
          <div className="tab-head">
            <div
              className={`radio-btn-profile ${
                isTabActive == "personal-info" ? "active" : ""
              }`}
            >
              <button
                href="#personal-info"
            ...
            {isOwner(profile.accessLevel) && (
              <div
                className={`radio-btn-profile ${
                  isTabActive == "company-info" ? "active" : ""
                }`}
              >
                <button
                  href="#company-info"
                  onClick={() => this.ChangeTab("company-info")}
                >
                  <span className="icon-bg-profile">
                  ...
                  <div className="column-container">
                    ...
                    <div className="col-12 col-md-8 form-field">
                      ...
                      >
                        ...
                        <option value="Influencer / Non-business">
                          Influencer / Non-business
                        </option>
                        <option value="Self-employed">Self-employed</option>
                        <option value="Small or medium business (1-499 employees)">
                          Small or medium business (1-499 employees)
                        </option>
                        <option value="Enterprise (500+ employees)">
                          Enterprise (500+ employees)
                        </option>
                        <option value="NGO / Non-profit / Governmental organization">
                    ...
                    <div className="clearer form-field col-12 col-md-8  ">
                      ...
                      <div className="clearfix text-right">
                        <NavLink
                          to="/twitter-booster/keyword-targets"
                          className="default-white-btn pull-right"
                        >
                          Edit hashtags
                        </NavLink>
                      </div>
                      <div className="added-items">
                        {targets.map((target, index) => (
                          <div
                            className="keyword-item added-keyword"
                            key={index}
                          >
                            #{target.keyword}
                          </div>
              ...
              <form onSubmit={(e) => this.onSubmit(e)} className="profile-form">
                <div className="form-group shadow-box main-content-style">
                  ...
                  <div className="col-12 col-md-8 form-field form-country">
                    ...
                    />
                    {openCountry && <ul className="country-list">{items}</ul>}
                  </div>
                  ...
                  <div className="col-12 col-md-8 form-field">
                    ...
                    <input
                      ...
                      placeholder="Example: 22 E 22Th St, New York, NY 10033"
                    />
                  </div>
                  <div className="col-12 col-md-8 form-field">
                    ...
                    <input
                      ...
                      placeholder="info@uniclixapp.com"
                    />
                  </div>
                  <div className="col-12 col-md-8 form-field">

...
class Checkout extends React.Component {
  ...
  componentDidMount() {
    ...
    this.setState({
      planTitle:
        this.props.planName.charAt(0).toUpperCase() +
        this.props.planName.slice(1) +
        " Plan",
    });
  }
  setLocation = (val) => {
    ...
    window.Stripe.card.createToken(
      ...
      (status, response) => {
        if (status === 200) {
          ...
          this.setState({
            stripeError:
              "The card number is incorrect. Please change it and try again.",
            loading: true,
          });
        }
      }
  ...
  CheckCoupon = () => {
    ...
    checkCoupon(this.state.couponCode)
      .then((response) => {
  ...
  onToken = (token) => {
    token.plan =
      this.props.billingPeriod === "annually"
        ? this.props.planName + "_annual"
        : this.props.planName;
    token.trialDays = 0;
      ...
      .then((response) => {
        this.props.startSetChannels().then((res) => {
          this.props.startSetProfile().then((res) => {
            ...
            this.props.navigateToCongrats(this.props.planName);
          });
        });
      })
      .catch((e) => {
  ...
  saveCardInfo = (e) => {
    ...
    window.Stripe.card.createToken(
      ...
      (status, response) => {
        ...
        response.couponCode =
          this.props.billingPeriod === "annually" ? this.state.couponCode : "";
        if (status === 200) {
              ...
              {!!deleteCard && (
                ...
                >
                  ...
                  <div style={{ float: "right" }}>
                    <button
                      onClick={() => this.setDeleteCard(false)}
                      className="cancelBtn"
                    >
                      Cancel
                    </button>
              ...
              <div className="row">
                <div className="col-md-6">
                  <div className="section-header no-border">
                    ...
                    <p>
                      Review your order summary and enter your payment
                ...
                <div className="col-md-7">
                  ...
                  {setStart && !endCardSetting ? (
                    <div
                      ...
                      onClick={() => this.setState({ setStart: false })}
                    >
                    ...
                    editCardSetting ? (
                          ...
                          <div className="card-inputs form-field row">
                            <div className="col-12 col-md-6">
                              <input
                                ...
                                onChange={(e) =>
                                  this.checkIfValidCC(e.target.value)
                                }
                                type="tel"
                            ...
                            <div className="col-12 col-md-3">
                              ...
                              <img
                                className="cvv-image"
                                src="/images/cvv-image.svg"
                              />
                            </div>
                          </div>
                          <div>
                            {form.cardnumber == "" ? (
                              <button className="save-card-button disabled-btn">
                                Save card
                              </button>
                            ) : (
                              <button
                                className="save-card-button"
                                onClick={(e) => this.saveCardInfo(e)}
                              >
                                Save card
                              </button>
                            )}
                      ...
                      <div
                        className="card-save-result row"
                        onClick={() =>
                          this.setState({
                            editCardSetting: true,
                            editCardInfo: false,
                          })
                        }
                      >
                  ...
                  <div className=" plan-info-container">
                    ...
                    <div className="plan-content">
                      <div className="row-price">
                        <div className="plan-content-description">
                          {planTitle}
                        </div>
                        <div className={`price`}>
                          <div
                            className={
                              discountPercentage > 0 ? "with-discount" : ""
                            }
                          >
                            $
                            {billingPeriod === "annually"
                      ...
                      {discountPercentage > 0 && (
                        <div className="row-price discount-row">
                          <p className="plan-content-description">
                            With discount
                          </p>
                    ...
                    <div className="order-total table">
                      <div className="row-price">
                        <div className="col-price">
                          ...
                          <p className="plan-content-accounts">
                            {billingPeriod === "annually"
                              ? "Annually"
                              : "Monthly"}
                          </p>
                    ...
                    {discountPercentage === -1 && (
                      <div className="invalid-code">The code is invalid</div>
                    )}
                    {form.cardnumber != "" ? (
                      <button
                        className="btn-blue"

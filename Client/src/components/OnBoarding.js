...
class OnBoarding extends React.Component {
  ...
  componentDidMount() {
    const {
      location: {
        state: { comingFromRegister } = { comingFromRegister: false },
      },
    } = this.props;
  ...
  onSubmit = () => {
    ...
    saveOnBoardingQuestions({ howDidYouFindUs, businessDescription }).then(
      () => {
            ...
            <div className="fields">
              ...
              <div className="input-set">
                ...
                <Select
                  ...
                  placeholder="Select an option"
                  onChange={(ans) =>
                    this.setState({ businessDescription: ans })
                  }
                  size="large"
                  style={{ width: "529px" }}
                >
